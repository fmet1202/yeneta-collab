...
export default function ChatWindow({ 
  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 md:p-8 relative scroll-smooth bg-slate-50">
      {messages.length === 0 ? (
        ...
        <div className="max-w-4xl mx-auto flex flex-col w-full pb-6">
          {messages.map((msg) => (
          ...
          {isTyping && (
            <div className="flex justify-start my-3">
              <div className="bg-white border border-gray-100 rounded-2xl rounded-bl-none p-4 shadow-sm flex items-center gap-1">
